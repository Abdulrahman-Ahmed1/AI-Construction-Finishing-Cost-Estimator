...
TRANSLATIONS = {
    "en": {
        "welcome": "Welcome to Smart Finishing AI. I will ask you a few questions about your apartment and estimate the finishing cost.",
        ...
        "disclaimer": "This estimate is based on packaged product-price data and scenario-generated training data. It is an estimate, not a contractor quotation.",
        "restart": "Start a new estimate",
        "error": "I couldn't understand that answer. Please try again.",
        "continue": "Continue",
        "choose_language": "Choose your language",
        "language_description": "Please select your preferred language before starting the assistant.",
        "language": "Language",
        "settings": "Settings",
        ...
        "allocation_method": "The cost was allocated using product-price data and the training scenarios used by the model.",

        "master_bathrooms_error": "Master bathrooms cannot exceed total bathrooms.",
        "bathrooms_error": "Total bathrooms cannot be less than master bathrooms.",
    },
    ...
    "ar": {
        ...
        "language_description": "يرجى اختيار اللغة المفضلة قبل بدء المساعد.",
        "language": "اللغة",
        "settings": "الإعدادات",
        ...
        "allocation_method": "تم توزيع التكلفة التقديرية باستخدام بيانات أسعار المنتجات وبيانات التدريب المستخدمة في النموذج.",

        "master_bathrooms_error": "عدد حمامات الماستر لا يمكن أن يتجاوز إجمالي عدد الحمامات.",
        "bathrooms_error": "إجمالي عدد الحمامات لا يمكن أن يكون أقل من عدد حمامات الماستر.",
    },
}
...
def translate_unit(
    ...
    key = UNIT_KEYS.get(str(unit).lower())
